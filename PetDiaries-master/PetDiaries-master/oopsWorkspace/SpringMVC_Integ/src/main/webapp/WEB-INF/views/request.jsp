...
<c:set var="mystring" value="${userType}"/>
<c:set var="reqStatus" value="${request.requestState}"/>
<c:if test="${fn:substring(reqStatus,0,1)=='0'}">
...
<table>
	...
	<tr>
		...
		<td>
			...
			<form:hidden path="ownerId" value="${ownerId}"/>
		</td> 
	</tr>	<tr>
		<td>
